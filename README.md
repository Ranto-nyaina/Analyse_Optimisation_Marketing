...
Ce dépôt est le dépôt global du projet : il réunit le rapport, la présentation et le dashboard interactif (voir dashboard/README.md pour la documentation détaillée du dashboard seul).
...
│   ├── requirements.txt  
│   └── README.md               # documentation détaillée du dashboard  
└── data/  
    ├── customers_data.csv  
    ├── sales_data.csv  
    ├── products_data.csv  
